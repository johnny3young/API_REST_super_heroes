package com.young.api_rest_super_heroes
...
class RecyclerAdapter : RecyclerView.Adapter<RecyclerAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return ViewHolder(layoutInflater.inflate(R.layout.list_super_heroes,parent,false))
    }
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(superhero:Superhero, context: Context){
            ...
            itemView.setOnClickListener { Toast.makeText(context, superhero.superhero, Toast.LENGTH_SHORT).show() }
